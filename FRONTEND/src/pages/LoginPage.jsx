        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/10 p-8 shadow-2xl">
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-slate-300">
              ...
              <a href="/register" className="text-indigo-400 font-medium hover:text-indigo-300">
                Sign up
              </a>
            </p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white/5 border border-white/10 rounded-lg p-3 text-center">
                <p className="text-xs font-medium text-indigo-400 mb-1">Owner</p>
                <p className="text-xs text-slate-400">owner@company.com<br/>owner123</p>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-lg p-3 text-center">
                <p className="text-xs font-medium text-emerald-400 mb-1">Employee</p>
                <p className="text-xs text-slate-400">employee@company.com<br/>emp123</p>
              </div>
            </div>
          </div>
        </div>
